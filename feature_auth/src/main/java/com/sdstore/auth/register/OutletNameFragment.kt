...
import com.sdstore.auth.databinding.FragmentOutletNameBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.submitButton.setOnClickListener {
            ...
            if (outletName.isNotEmpty()) {
                ...
                findNavController().navigate(com.sdstore.auth.R.id.action_outletNameFragment_to_enterUserPhoneFragment)
            } else {
